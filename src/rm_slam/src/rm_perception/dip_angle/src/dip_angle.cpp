...
public:
        ...
        : Node("dip_angle")
    {
        ...
        dip_angle_pub = this->create_publisher<std_msgs::msg::Float64>(
            "dip_angle",10
        );
        RCLCPP_INFO(this->get_logger(), "Dip angle processer launched successfully!");
    }
    ...
    void odom_callback(const nav_msgs::msg::Odometry::SharedPtr msg)
    {
        ...
        std_msgs::msg::Float64 msg_l;
        msg_l.data = angle_deg;
        dip_angle_pub->publish(msg_l);

        RCLCPP_INFO(this->get_logger(), "current dip angle: %f", angle_deg);
    }

private:
    rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr odom_sub;

    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr dip_angle_pub;
};
