...
{
class SubRobotStatusAction : public BT::RosTopicSubNode<rm_decision_interfaces::msg::CvDecision>
{
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<rm_decision_interfaces::msg::CvDecision>("robot_status")};
  }
