...
#include "navigation_interfaces/msg/detail/navigation__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float64__functions.h"  // dip_angle
...
using _Navigation__ros_msg_type = navigation_interfaces__msg__Navigation;
...
size_t get_serialized_size_navigation_interfaces__msg__Navigation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Navigation__ros_msg_type * ros_message = static_cast<const _Navigation__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Navigation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_navigation_interfaces__msg__Navigation(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_navigation_interfaces
size_t max_serialized_size_navigation_interfaces__msg__Navigation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces__msg__Navigation;
    is_plain =
      (
...
static size_t _Navigation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_navigation_interfaces__msg__Navigation(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigation_interfaces, msg, Navigation)() {
