...
bool navigation_interfaces__msg__navigation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("navigation_interfaces.msg._navigation.Navigation", full_classname_dest, 48) == 0);
  }
  navigation_interfaces__msg__Navigation * ros_message = _ros_message;
  {  // twist
  ...
  {  // dip_angle
    PyObject * field = PyObject_GetAttrString(_pymsg, "dip_angle");
    if (!field) {
      return false;
    }
    if (!std_msgs__msg__float64__convert_from_py(field, &ros_message->dip_angle)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * navigation_interfaces__msg__navigation__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("navigation_interfaces.msg._navigation");
  ...
  {  // dip_angle
    PyObject * field = NULL;
    field = std_msgs__msg__float64__convert_to_py(&ros_message->dip_angle);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "dip_angle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
