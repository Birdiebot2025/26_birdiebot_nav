...
#define NODE_MAIN_LOGGER_NAME "fake_baselink_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfake_baselink.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<FakeBaselink>";
