...
cmds=(
	...
	"ros2 launch '/home/hero/Desktop/birdiebot_nav_ws/src/rm_serial_driver/launch/serial_driver.launch.py'"
...
do
	...
	gnome-terminal -x bash -c "cd /home/hero/Desktop/birdiebot_nav_ws;source /opt/ros/humble/setup.bash ;$cmd;exec bash;"
	sleep 2
done
