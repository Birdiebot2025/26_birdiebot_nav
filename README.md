...
测量机器人底盘正中心到雷达的相对坐标x, y 距离比较重要，将影响云台旋转时解算到 base_link 的坐标准确性，填入 sentry_robot_real.xacro
...
若雷达扫描到底盘，可更改 /26_birdiebot_nav/src/rm_slam/src/rm_nav_bringup/launch/bringup_real.launch.py - bringup_pointcloud_to_laserscan_node - parameters - range_min